...
supabase/migrations/202605030011_legacy_budget_item_column_repair.sql
```
...
The `202605030011_legacy_budget_item_column_repair.sql` migration clears old required columns such as `name`, `item_type`, and `starts_on` after their data has been copied into the current budget item columns.
